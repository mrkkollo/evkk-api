...
class TextCorrectionSerializer(serializers.Serializer):
    ...
    show_candidates = serializers.BooleanField(default=False, help_text="Whether to include the candidates of each word in the output, increases the output size by a significantly.")
